//! Fase 6 — Testes E2E do monomorphizador.
//!
//! Verifica que:
...
//! como OverloadInfo, não em `mono.functions`. A refatoração da Fase 6 faz
//! o monomorphizador gerar OverloadInfo sempre (para o DispatchTable) e
