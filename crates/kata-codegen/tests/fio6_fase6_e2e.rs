//! Fio 6 Fase 6 — Testes E2E de coerção contextual no `|` e grouped ascription.
//!
...
/// DoD 12 vs Fase 5: diferença entre `(expr)::Type` e `((expr))::Type`
...
fn dod12_ret_directed_seleciona_com_hint() {
    ...
    assert_eq!(ty, Ty::int());
    // double-tagging (ver Fase 5 test), mas prova dispatch Int→Int
