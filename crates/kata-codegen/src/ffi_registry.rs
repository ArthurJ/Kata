...
pub(crate) fn register_ffi_symbols(builder: &mut cranelift_jit::JITBuilder) {
    ...
    builder.symbol(
        "kata_rt_tensor_new",
        rt::tensor::kata_rt_tensor_new as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_rank",
        rt::tensor::kata_rt_tensor_rank as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_shape",
        rt::tensor::kata_rt_tensor_shape as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_at",
        rt::tensor::kata_rt_tensor_at as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_at_nd",
        rt::tensor::kata_rt_tensor_at_nd as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_sub",
        rt::tensor::kata_rt_tensor_sub as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_add",
        rt::tensor::kata_rt_tensor_add as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_mul",
        rt::tensor::kata_rt_tensor_mul as *const u8,
    );
    builder.symbol(
    ...
    builder.symbol(
        "kata_rt_tensor_dot",
        rt::tensor::kata_rt_tensor_dot as *const u8,
    );
    builder.symbol(
    ...
    builder.symbol(
        "kata_rt_tensor_scale",
        rt::tensor::kata_rt_tensor_scale as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_shift",
        rt::tensor::kata_rt_tensor_shift as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_free",
        rt::tensor::kata_rt_tensor_free as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_show",
        rt::tensor::kata_rt_tensor_show as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_eye_int",
        rt::tensor::kata_rt_tensor_eye_int as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_eye_float",
        rt::tensor::kata_rt_tensor_eye_float as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_zeros_int",
        rt::tensor::kata_rt_tensor_zeros_int as *const u8,
    );
    builder.symbol(
        "kata_rt_tensor_zeros_float",
        rt::tensor::kata_rt_tensor_zeros_float as *const u8,
    );
}
